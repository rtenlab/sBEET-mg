#ifndef __STEREODISPARITY_KERNEL_H__
#define __STEREODISPARITY_KERNEL_H__
...
////////////////////////////////////////////////////////////////////////////////
STGM_DEFINE_KERNEL(stereoDisparityKernel, unsigned int *g_img0, unsigned int *g_img1,
                      ...
                      int minDisparity, int maxDisparity)
{
  ...
  for (int ITER = 0; ITER < 2; ITER++) {
    ...
    const int tidx = blockDim.x * BLOCKIDX_X + threadIdx.x;
    const int tidy = blockDim.y * BLOCKIDX_Y + threadIdx.y;
...
#endif // __STEREODISPARITY_KERNEL_H__
