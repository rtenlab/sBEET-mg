#ifndef __HOTSPOT_KERNEL_H__
#define __HOTSPOT_KERNEL_H__
...
STGM_DEFINE_KERNEL(calculate_temp, int iteration,  //number of iteration
    ...
    float time_elapsed)
{
    ...
    if (computed) temp_dst[index]= temp_t[ty][tx];

    KERNEL_EPILOGUE();
}

#endif /* __HOTSPOT_KERNEL_H__ */